...
export const gridItems: HomeGridItem[] = [
    ...
    },
    {
        ...
        url: "/negative-inventory",
        image: {
            viewBox: "0 0 16 16",
            path: "M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1A2.5 2.5 0 0 1 9.5 5h-3A2.5 2.5 0 0 1 4 2.5zM6 9h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1"
        },
        phrase: "Handle Negative Inventory"
    }
]