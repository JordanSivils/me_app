       ...
       <ul className={`flex-col`}>
        ...
        <li>
            <div className={`flex-col`}>
                ...
                <img src="/assets/Setting_Icon.webp" alt="Gear Icon" height={50} width={70} />
            </div>
        </li>
        <li>
            <div className={`flex-col`}>
                ...
                <img src="/assets/Table_Settings.webp" alt="Gear Icon" height={300} width={500} />
                <p>b: Select the Show columns and make sure that suppliers is selected so you can sort by the targeted supplier.</p>
                <img src="/assets/Select_Supplier.webp" alt="Gear Icon" height={180} width={500} />
            </div>
        </li>
        <li>
            <div className={`flex-col`}>
                ...
                <img src="/assets/Highlighted_lines_Redacted.webp" alt="Gear Icon" height={300} width={500} />
        ...
        <li>
            <div className={`flex-col`}>
                ...
                <img src="/assets/Smart_Export.webp" alt="Gear Icon" height={50} width={70} />
                <p>B: Select the Options for "Selected Records"! This will immediately create an excel file with the selected lines.</p>
                <img src="/assets/Correct_Export.webp" alt="Gear Icon" height={300} width={300} />
            </div>
        </li>
        <li>
            <div className={`flex-col`}>
